...
public class WebController {
	...
	public String votacoesCurso(final Model model, HttpSession session) {
	...
	public String votarProposta(@PathVariable Long id, @RequestParam("propostaId") Long propostaId, @RequestParam("tipoVoto") String tipoVoto, HttpSession session) {
		...
		VOTO_DELEGADO votoCidadao = null;
		if (tipoVoto == null || tipoVoto.equals("null")) {
		    votoCidadao = null;
		} else if (tipoVoto.equals("favoravel")) {
		    votoCidadao = VOTO_DELEGADO.FAVORAVEL;
		} else if(tipoVoto.equals("desfavoravel")){
		    votoCidadao = VOTO_DELEGADO.DESFAVORAVEL;
		}
