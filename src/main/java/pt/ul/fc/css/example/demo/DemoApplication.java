...
//    }
	...
	public CommandLineRunner demo(
		...
		return (args) -> {
			...
			Timestamp timestamp2 = new Timestamp(System.currentTimeMillis() + 10000); //10s
			Timestamp timestamp3 = new Timestamp(System.currentTimeMillis() + 600000); // 10m
			...
			Votacao v2 = new Votacao(timestamp, timestamp3, projLei2);
