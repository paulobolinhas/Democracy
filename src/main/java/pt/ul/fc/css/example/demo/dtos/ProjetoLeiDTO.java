...
public class ProjetoLeiDTO {
	...
	public String toString() {
		return "ProjetoLeiDTO [id=" + id + ", titulo=" + titulo + ", descricao=" + descricao + ", datahoraValidade="
				+ datahoraValidade + ", subtema=" + subtema + ", delegadoProponente=" + delegadoProponente
				+ ", numeroApoiantes=" + numeroApoiantes + "]";
	}
